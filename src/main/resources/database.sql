...
CREATE TABLE Descuentos (
    id INT AUTO_INCREMENT PRIMARY KEY,
    tipo_descuento ENUM('Monto fijo', 'Porcentaje') NOT NULL,
    descuento_cliente BOOLEAN not null;
    CondicionesDeAplicacion TEXT NOT NULL,
    Monto DECIMAL(10, 2) NOT NULL,
    id_Productos int NOT NULL,
    Estado ENUM('activo', 'inactivo') NOT NULL DEFAULT 'activo',
    Foreign Key (id_Productos) REFERENCES Producto(codigo)
);

ALTER TABLE Factura
ADD id_descuento INT,
ADD FOREIGN KEY (id_descuento) REFERENCES Descuentos(id);
