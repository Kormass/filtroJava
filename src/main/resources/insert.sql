...
INSERT INTO Descuentos (tipo_descuento, descuento_cliente, CondicionesDeAplicacion, Monto, id_Productos, Estado)
    VALUES  ("Porcentaje", True, "Monto minimo de compra: $1000", 10, 1, "activo"),
            ("Monto fijo", True, "Compra de al menos 5 unidades del producto x", 5, 2, "activo"),
            ("Porcentaje", True, "Cliente gold con más de 10 compras previas", 15, 3, "activo"),
            ("Porcentaje", True, "Compra durante las temporadas navideñas", 5, 5, "activo"),
            ("Monto fijo", True, "Valido solo los viernes", 3, 4, "activo");
